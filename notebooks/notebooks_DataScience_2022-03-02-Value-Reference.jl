...
# ╔═╡ be836df9-cf91-4a69-a088-cf3db45025be
md"""
- 参考书： Nazarathy, Y., & Klok, H. (2021). *Statistics with Julia: Fundamentals for data science, machine learning and artificial intelligence*. Springer.
"""

# ╔═╡ fa958b4a-5161-4650-8f87-94ee5b2ee252
md"""
### 调用方式
"""

# ╔═╡ 1528dc56-3a0d-48b0-a509-470612f8f591
md"""
- call by **value**: immutable (primitive type: Integer, Int64)
- call by **reference**: mutable (Array)
"""

# ╔═╡ 569c76b9-2c3a-4138-b81b-9d02c723b9c4
[typeof(1:5), typeof(collect(1:5))]

# ╔═╡ fb338d3b-a0b6-468b-9fc4-e88388082c04
x1, x2, x3, x4, x5 = 5, [5], 5.0, "五", collect(1:5);

# ╔═╡ 06103863-43b5-4df2-8bd0-5b9ea6721340
[typeof(x1), typeof([x1]), typeof(x5)]

# ╔═╡ f60012ab-fefc-4888-8e6c-bd0ecdc87556
[isimmutable(x1), isimmutable([x1])]

# ╔═╡ 7511d465-c3fd-440f-ac5c-68b2b2417c0f
isa(x1, Int)

# ╔═╡ 73f4f751-a999-436e-a3f3-750630f0e3aa
f(z::Int) = z = 0

# ╔═╡ 08a8b0fa-5f16-491a-9ecc-5e16a5483815
f(z::Array{Int}) = z[1] = 0

# ╔═╡ 866afbdb-8894-4f3a-8ff0-4b0513e02038
f(z) = 100

# ╔═╡ 44872d73-a803-439d-888b-d21093678754
[f(x1), x1]

# ╔═╡ 97cc0978-ba8b-45ea-ad8f-b4065df6a27d
[isa(x1, Array{Int}), isa([x1], Array{Int}), isa(x2, Array{Int}), isa([5.0], Array{Int})]

# ╔═╡ 816f1547-2638-451b-904a-4a5dff86880d
[f(x2), x2]

# ╔═╡ 81c4fcd6-1573-4296-8a35-702c379ba51d
[f(x3), x3]

# ╔═╡ 60d37b5f-2e10-4850-88ab-4c29cf61c983
[f(x4), x4]

# ╔═╡ ee2f71b8-448d-4676-b2aa-910f44935e57
[f(x5), x5]

# ╔═╡ 1203936a-03ef-484c-b605-6d945b6f2183
md"""
- `copy()` 和 `deepcopy()`
"""

# ╔═╡ 5977d7c7-cb14-440e-abcf-99a2bd990ef2
begin
	b1 = a1 = 10
	b1 = 0
end

# ╔═╡ f99c19c9-a544-4c70-a0dc-96187b40e19e
a1, b1 # tuple

# ╔═╡ c7944b6a-d3e3-4372-84f2-8d1cadcb5b7c
begin
	b2 = a2 = [10, 300]
	b2[1] = 0
end

# ╔═╡ 2d98dfbd-69cd-45cc-9f2c-d19fbd29e76c
a2, b2

# ╔═╡ 6ee9e15e-0f2f-4443-a544-afc49f41e276
begin
	a3 = [10, 300]
	b3 = copy(a3)
	b3[1] = 0
...
# ╔═╡ 0e8f7e62-d758-4586-bcca-210021838c69
a3, b3

# ╔═╡ 066353d2-80d0-4e26-9f7b-d498e770f944
begin
	a4 = [[10, 300]]
	b4 = copy(a4)
	b4[1][1] = 0
...
# ╔═╡ 76303045-6874-4e67-826f-de57c670a7f1
typeof(a4), typeof(a4[1]), typeof(a4[1][1])

# ╔═╡ 0c7a1aff-1224-4574-a3f7-240117630ceb
a4, b4

# ╔═╡ b9b814b4-a56f-478f-a687-a2c8f2284bb2
begin
	a5 = [[10, 300]]
	b5 = deepcopy(a4)
	b5[1][1] = 0
...
# ╔═╡ 734d0621-6d58-432f-a378-4bac0c7a1324
a5, b5

# ╔═╡ 8d7053b7-bf5b-477e-a490-d8656d6044ff
md"""
### 数据框
"""

# ╔═╡ 3555a33e-99cf-11ec-047c-d7f3309ecac6
using DataFrames, CSV

# ╔═╡ f5face4f-45cf-4415-bd51-94d9dafab496
md"""
- [数据地址](https://raw.githubusercontent.com/h-Klok/StatsWithJuliaBook/master/data/purchaseData.csv)
"""

# ╔═╡ a728314e-e82f-40fb-b2f4-c8f7bad5a120
dataRaw = """
...
# ╔═╡ 4419e6d7-559e-4d09-917c-2363eacbfa52
data = CSV.read(IOBuffer(dataRaw), DataFrame);

# ╔═╡ 09748bd8-523e-4bc9-83a8-d78bd83f29db
describe(data)

# ╔═╡ a4293a7a-e1be-43d8-a9b0-7cf6c064f9da
size(data)

# ╔═╡ 3c204875-51ee-4312-a3ed-cb824af56a13
names(data)

# ╔═╡ a8d12bba-c582-4753-a3b2-ff66621a2287
first(data, 5)

# ╔═╡ 52502e8c-a735-4eac-acbe-5ae87e891be8
data[1, 1:3] #[row, column]

# ╔═╡ 29343af5-5dd0-40b2-a562-3df683f3a03f
data[1:2, [1, 3]] #[row, column]

# ╔═╡ f0dfeb49-61fb-4ba3-bcf4-fb387f841331
data[1:5, :Name] #[row, column]

# ╔═╡ a76da3cd-ad25-4724-90e0-838c7f8ea95e
data[1:5, [:Grade, :Name]] #[row, column]

# ╔═╡ 8426a0f6-8a5b-49ac-abcb-1bfba14c2e6a
data[1, :Name] = "XXXX"

# ╔═╡ fe35707b-812f-47d1-9db1-b4d9bdc74dfd
data.Price = data.Price ./ 1000

# ╔═╡ 02e808de-42bb-450a-8fac-967822fef3aa
data.Grade

# ╔═╡ 47f0a93c-b8af-4945-a27f-7252f4db3248
data.Name

# ╔═╡ 3f91641f-a890-460f-a446-dc2c33fd078a
